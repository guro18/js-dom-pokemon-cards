...
pokemonName.textContent = data[i].name.toLocaleUpperCase();
...
//function for toggleswitch
function changeImage() {
    if (pokemonImage.src === data[i].sprites.other["official-artwork"].front_default){
...
cardListItem.addEventListener("click", changeImage);
